  ...
  <div class="page-wrap">
    ...
    <div v-if="tab === 'installed'" class="ext-grid">
      <div v-for="ext in installed" :key="ext.name" class="ext-card">
        ...
        <div class="ext-btns">
          <button class="pill-btn">Launch</button>
...
.ext-card {
  background: #fff; border-radius: 8px; padding: 20px; border: 1px solid #e5e7eb;
...
.ext-dot  { width: 8px; height: 8px; border-radius: 50%; background: #22c55e; flex-shrink: 0; }
